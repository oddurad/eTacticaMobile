...
public class Users extends Controller {
    ...
    /**
     * @param username: of a user trying to login
     * @param password: of a user trying to login
     */
    public static void login(String username, String password) {
        //Check if all information has been filled in
        Validation.required("username", username).message("Please fill in a username");
        Validation.required("password", password).message("Please fill in a password");
